...
extension NSViewController {
    ...
    public func toast(message: String, title: String, image: NSImage? = NSImage(named: NSImage.cautionName)) {
        let t = makeToast(message: message, title: title, image: image ?? NSImage())
